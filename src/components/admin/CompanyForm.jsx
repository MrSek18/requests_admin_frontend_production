  ...
  return (
    ...
    >
      <div className="h-full w-full max-w-md space-y-6 bg-white rounded-xl shadow-lg overflow-y-auto">
        ...
        {/* Formulario */}
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-4 text-blue-800">Crear Compañía</h2>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input
              ...
              placeholder="Ej. Industrias del Sur"
              required
            />
            ...
            <label className="block mb-2 font-medium text-gray-700">Sector</label>
            <input
              type="text"
              className="w-full border px-3 py-2 rounded mb-4"
              value={sector}
